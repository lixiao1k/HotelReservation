...
public class HotelWorkerBrowseOrderList  implements Initializable{
	...
	public void getController(){
	   	FXMLLoader loader=new FXMLLoader(getClass().getClassLoader().getResource("Presentation/MainUI/ClientMainUI.fxml"));
    	clientMainUIController=loader.getController();
	}
    ...
    public void setClientCancalOrder(){
    	try {
			Parent PersonInfo = FXMLLoader.load(getClass().getClassLoader().getResource("Presentation/OrderUI/ClientCancelOrder.fxml"));
			PersonInfo.getProperties().put("NAME", "ClientCancelOrderPane");
